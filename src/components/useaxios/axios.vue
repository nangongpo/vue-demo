...
export default {
  ...
  methods: {
    getRequest() {
      const loginUrl = this.TEST + '/users/signin.php'
    ...
    getMovie() {
      ...
      const movieUrl = this.HOST + '/movie/top250'
      this.$axios({
        method: 'get',
        url: movieUrl,
        params: {
    ...
    logout() {
      const logoutUrl = this.TEST + '/users/signout.php'
      this.isLogin()
      if (!this.status) {
    ...
    postRequest() {
      const registerUrl = this.TEST + '/users/register.php'
    ...
    check_uname() {
      const checkUnameUrl = this.TEST + '/users/checkUname.php'
      this.$axios({
        method: 'post',
        url: checkUnameUrl,
    ...
    isLogin() {
      const isloginUrl = this.TEST + '/users/islogin.php'
